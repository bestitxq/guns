...
// */
//@Component
//@DependsOn("springContextHolders")
//public class ConstantFactorys implements IConstantFactory {
//
//
...
//    private BlogMapper blogMapper = SpringContextHolder.getBean(BlogMapper.class);
...
//        return SpringContextHolder.getBean("constantFactorys");
//    }
//
//    @Override
...
//
//    @Override
//    public String getBlogTitle(Long dictId) {
//        if (ToolUtil.isEmpty(dictId)) {
//            return "";
//        } else {
//            Blog blog = blogMapper.selectById(dictId);
//            if (blog == null) {
//                return "";
//            } else {
//                return blog.getArticleTags();
//            }
//        }
//    }
//
